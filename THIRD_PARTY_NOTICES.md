...
## Noetix Robotics N2 robot description

Model: N2 18-DOF

Source: https://github.com/Noetix-Robotics/noetix_n2_gym

Pinned source revision: 153aad12dcc44aeafe378efe2f652873b02e0d89

License: BSD-3-Clause. A copy is provided at
licenses/noetix-BSD-3-Clause.txt and with the packaged Noetix assets.

The RIMKit-local MJCF uses the shared scene and adds fixed trunk, hand, sole,
and toe landmarks for contact-aware retargeting. File-level provenance and
hashes are recorded in the adjacent SOURCE.yaml manifest.
