...
from rimkit.robots.profiles.schema import IkSolverProfile, InitialCollisionProfile
...
N2_INITIAL_COLLISION_PROFILE = replace(
    _BASE_INITIAL_COLLISION_PROFILE,
    robot_id="n2",
    qpos_dim=25,
    root_body_name="base_link",
    movable_body_prefixes=("L_arm_", "R_arm_"),
)
